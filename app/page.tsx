...
import {
  ...
  ArrowRight, CheckCircle, Trophy, Quote,
} from "lucide-react";
...
const photoGrid = [
  { src: "images/WhatsApp Image 2026-03-31 at 14.09.00 (7).jpeg",  label: "Outings",            span: true  },
  { src: "images/WhatsApp Image 2026-03-31 at 14.09.01 (9).jpeg",  label: "Special Education",  span: false },
  { src: "images/WhatsApp Image 2026-03-31 at 14.09.01 (10).jpeg", label: "Sports & Champions", span: false },
  { src: "images/WhatsApp Image 2026-03-31 at 14.09.00 (2).jpeg",  label: "Arts & Recreation",  span: false },
  { src: "images/WhatsApp Image 2026-03-31 at 14.09.03 (1).jpeg",  label: "Family & Community", span: false },
];
  ...
  return (
    <>
      ...
      <main style={{ background: C.cream, fontFamily: font.serif, color: C.textMain }}>
        ...
        <section ref={heroRef} style={{ position: "relative", height: "100vh", overflow: "hidden" }}>
          ...
          <motion.div
            style={{
              ...
              padding: bp.isMobile ? "0 1.5rem" : "0 6vw",
              opacity: heroOpac,
            }}
          >
            <motion.div
            ...
            <motion.h1
              ...
              style={{
                ...
                fontSize: bp.isMobile ? "2.6rem" : "clamp(3rem, 7vw, 5.6rem)",
            ...
            <motion.p
              ...
              style={{
                fontFamily: font.serif, fontSize: bp.isMobile ? "1rem" : "1.08rem", lineHeight: 1.85,
            ...
            >
              ...
              <Link href="/programs" style={{
                border: "1.5px solid rgba(230,168,74,0.45)", color: C.amberGlow,
                padding: "0.95rem 2.4rem", borderRadius: "5px",
        ...
        {/* ════════ INTRODUCTION ════════ */}
        <section style={{ background: C.cream, padding: bp.isMobile ? "4rem 0" : "7rem 0" }}>
          <div style={{ maxWidth: "1180px", margin: "0 auto", padding: "0 2rem" }}>
            <div style={{
              ...
              >
                ...
                <h2 style={{
                  fontFamily: font.display, fontWeight: 700,
                  fontSize: bp.isMobile ? "2rem" : "clamp(2.2rem, 4vw, 3.2rem)", lineHeight: 1.15,
                ...
                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                  ...
                  <Link href="/programs" style={{
                    border: `1.5px solid ${C.borderMid}`, color: C.textMain, background: "transparent",
                    padding: "0.85rem 2rem", borderRadius: "5px",
                    fontFamily: font.sans, fontWeight: 600, fontSize: "0.76rem",
                    letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none",
        ...
        {/* ════════ STATS ════════ */}
        <section style={{
          background: C.textMain, padding: "6rem 2rem",
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            <div style={{
              ...
              {stats.map((stat, i) => {
                // On mobile 2-col: right-border on col 0, bottom-border on rows 0
                const isLastInRow = bp.isMobile ? i % 2 === 1 : i === stats.length - 1;
                const isBottomRow = bp.isMobile ? i >= 2 : false;
                return (
                  <motion.div
                    key={i}
                    ...
                    style={{
                      textAlign: "center",
                      padding: bp.isMobile ? "2rem 0.75rem" : "2.5rem 1.5rem",
                      borderRight: isLastInRow ? "none" : `1px solid ${C.amber}25`,
                      borderBottom: isBottomRow ? "none" : (bp.isMobile && i < 2 ? `1px solid ${C.amber}25` : "none"),
                      position: "relative",
                    }}
                  >
                    <div style={{
                    ...
                    <div style={{
                      fontFamily: font.display, fontWeight: 700,
                      fontSize: bp.isMobile ? "2.4rem" : "3.2rem",
                      color: C.white, lineHeight: 1, marginBottom: "0.4rem",
                    }}>
        ...
        {/* ════════ PROGRAMS ════════ */}
        <section style={{ background: C.pale, padding: bp.isMobile ? "4rem 1.25rem" : "7rem 2rem" }}>
          <div style={{ maxWidth: "1180px", margin: "0 auto" }}>

            <div style={{
              display: "grid",
              gridTemplateColumns: bp.isDesktop ? "1fr 1fr" : "1fr",
              gap: bp.isDesktop ? "3rem" : "1.5rem",
              ...
              <div>
                ...
                <h2 style={{
                  fontFamily: font.display, fontWeight: 700,
                  fontSize: bp.isMobile ? "2rem" : "clamp(2.2rem, 4vw, 3rem)", lineHeight: 1.15,
            ...
            <div style={{
              ...
              {programs.map((prog, i) => (
                <motion.div
                  ...
                  whileHover="hover"
                  variants={{ hover: { backgroundColor: C.pale } }}
                  style={{
        ...
        {/* ════════ PHOTO GRID ════════ */}
        <section style={{ background: C.cream, padding: bp.isMobile ? "4rem 1.25rem" : "7rem 2rem" }}>
          <div style={{ maxWidth: "1180px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              <Eyebrow>Our Impact in Action</Eyebrow>
              <h2 style={{
                fontFamily: font.display, fontWeight: 700,
                fontSize: bp.isMobile ? "1.9rem" : "clamp(2rem, 4vw, 2.8rem)",
                color: C.textMain, letterSpacing: "-0.01em",
              ...
              <div style={{
                ...
                {photoGrid.map((img, i) => (
                  ...
                  >
                    ...
                    />
                    <motion.div
                      style={{ position: "absolute", bottom: "1.25rem", left: "1.25rem", opacity: 0 }}
              ...
              <div style={{
                ...
                {photoGrid.map((img, i) => (
                  ...
                  >
                    ...
                    <div style={{
                      position: "absolute", inset: 0,
                      background: "linear-gradient(to top, rgba(30,15,0,0.45) 0%, transparent 60%)",
                    }} />
                    <span style={{
                      ...
                      letterSpacing: "0.14em", textTransform: "uppercase",
                      color: C.amberGlow,
                      background: "rgba(0,0,0,0.35)", padding: "0.25rem 0.6rem",
                      borderRadius: "3px",
                    }}>{img.label}</span>
                  </motion.div>
                ))}
            ...
            {bp.isMobile && (
              <div style={{ display: "flex", flexDirection: "column", gap: "10px", borderRadius: "10px", overflow: "hidden" }}>
                {photoGrid.map((img, i) => (
                  <motion.div
                    key={i}
                  ...
                  >
                    ...
                    <div style={{
                      position: "absolute", inset: 0,
                      background: "linear-gradient(to top, rgba(30,15,0,0.5) 0%, transparent 55%)",
                    }} />
                    <span style={{
                      position: "absolute", bottom: "0.9rem", left: "1rem",
        ...
        <section style={{
          ...
          padding: bp.isMobile ? "5rem 1.5rem" : "7rem 2rem",
          position: "relative", overflow: "hidden",
        }}>
          ...
          <div style={{ maxWidth: "860px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
            ...
            >
              ...
              <h2 style={{
                fontFamily: font.display, fontWeight: 700,
                fontSize: bp.isMobile ? "2.4rem" : "clamp(2.4rem, 5vw, 4rem)",
                lineHeight: 1.1, color: C.white, marginBottom: "1.25rem", letterSpacing: "-0.015em",
              }}>
                From Margins<br />
              ...
              <p style={{
                ...
                color: "rgba(255,240,200,0.7)", marginBottom: "3rem",
        ...
        {/* ════════ CTA ════════ */}
        <section style={{ background: C.parchment, padding: bp.isMobile ? "4rem 1.25rem" : "7rem 2rem" }}>
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            ...
            >
              {/* Image panel — hidden on mobile to keep CTA clean */}
              {!bp.isMobile && (
                <div style={{ position: "relative", minHeight: "400px" }}>
                  ...
                  <div style={{
                    position: "absolute", inset: 0,
                    background: bp.isDesktop
                      ? "linear-gradient(to right, transparent 40%, rgba(255,252,245,0.95) 100%)"
                      : "linear-gradient(to top, transparent 40%, rgba(255,252,245,0.95) 100%)",
                  }} />
                </div>
              )}

              <div style={{
                padding: bp.isMobile ? "2.5rem 1.75rem" : "4rem 3.5rem",
                display: "flex", flexDirection: "column", justifyContent: "center",
              }}>
                ...
                <h2 style={{
                  fontFamily: font.display, fontWeight: 700,
                  fontSize: bp.isMobile ? "1.9rem" : "clamp(1.8rem, 3vw, 2.6rem)", lineHeight: 1.2,
